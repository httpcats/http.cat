...
The HTTP **`402 Payment Required`** [client error response](https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Status#client_error_responses) status code is a **nonstandard** response status code reserved for future use.
...
[HTTP Semantics  
\# status.402](https://httpwg.org/specs/rfc9110.html#status.402)

### Compatibility notes

This status code is _reserved_ but not defined. Actual implementations vary in the format and contents of the response. No browser supports a 402, and an error will be displayed as a generic `4xx` status code.
...
**Source:** [https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Status/402](https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Status/402)
